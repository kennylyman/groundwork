      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8">
          ...
          <a
            ...
            className="block w-full bg-gray-900 text-white text-sm font-medium py-3 rounded-xl text-center hover:bg-gray-700 transition-colors mb-4"
          >
          ...
          <div className="space-y-3">
            <p className="text-xs font-medium text-gray-700">After downloading</p>
            {[
              { step: '1', text: 'Double-click Groundwork.exe to run it' },
              { step: '2', text: 'If Windows warns you, click "More info" → "Run anyway"' },
              { step: '3', text: 'Groundwork runs silently in the background' },
              { step: '4', text: 'You\'ll see it in your system tray' },
            ].map(item => (
              <div key={item.step} className="flex gap-3">
                ...
                <p className="text-xs text-gray-600 pt-0.5">{item.text}</p>
              </div>
            ))}
          </div>
